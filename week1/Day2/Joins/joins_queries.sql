...
select e.emp_name , d.emp_name from employees e left join employees d on e.manager_id = d.emp_id;
...
select e.emp_name,m.emp_name as manager_name from employees e inner join employees m on e.manager_id = m.emp_id inner join projects p on e.emp_id = p.emp_id;
...
select e.emp_name,d.dept_name from employees e inner join departments d on e.emp_id = d.dept_id;
